...
- Scene 3D<br>
地球の伝統的な3D透視図です。
3Dで作業することで、地形の動きや、樹木、建物、地下地質などの特徴の3D範囲などの影響を強調し、コンテンツに現実世界の要素を組み込むことができます。
...
- Scene 2D<br>
地図は正射投影で上から下に表示されます。
このオプションは、紙面が焦点を当てている場所の様々な角度で高品質の2D画像を取得することができます。キャリブレーションされたカメラから取得した2D画像から特徴点を特定し、深度解析を使用してそれらの特徴点を再構築し、オブジェクトまたは画像の3Dビューを取得します。
