...
マップ全体を正方形のタイルとして分割されたのもを、デジタルアース上に敷き詰めることによって、様々なテイストのマップを効率的に表示させることができます。<br>
これにより、ビューポート全体に対して単一のマップ画像を表示させるのに比べて、ズームインやズームアウトの際にも高いパフォーマンスを維持することができるので、ユーザーエクスペリエンスを大幅に向上させます。
