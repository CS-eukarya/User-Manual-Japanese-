...
1. 地球儀上で、任意の場所に3Dタイルのアイコンをドラッグ＆ドロップします。
...
- 3Dタイルを地球儀上に落とすと、左パネルのレイヤー内に「3Dタイル」が追加されます。追加または選択されている3Dタイルはレイヤー内で青く表示されます。
また、3Dタイルのアイコンを落としていくとレイヤーに表示される3Dタイルが増えていきます。
